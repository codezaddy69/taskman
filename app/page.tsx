...
import { Calendar, Clock, Plus, Settings, Bell, Zap, TrendingUp } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-lg font-bold text-foreground">TaskMan</h1>
                <p className="text-xs text-muted-foreground">AI-Powered Calendar & Todo Helper</p>
              </div>
            </div>
          </div>
          <div className="flex items-center space-x-2">
      ...
      <main className="container mx-auto px-4 py-6">
        {/* Tabs - Today | Calendar | Tasks | Gamification */}
